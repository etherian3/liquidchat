...
const ChatApp = () => {
  ...
  const fetchConversations = async () => {
    ...
    if (error) {
      ...
      const convos = data.map(item => item.conversations).filter(Boolean) as Conversation[];
  ...
  return (
    <div className="min-h-screen p-2 sm:p-4 animate-fade-in">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Header */}
        <Card className="glass-effect p-3 sm:p-6 mb-4 animate-scale-in">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm sm:text-base">Welcome, {profile?.display_name || profile?.username}</p>
              </div>
            </div>
